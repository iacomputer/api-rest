...
const handleResponse = (data: string, server: FastifyInstance, resolve: () => void, reject: (reason?: any) => void) => {
  try {
...
const handleError = (message: string, server: FastifyInstance, reject: (reason?: any) => void, error?: Error) => {
